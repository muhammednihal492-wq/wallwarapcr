...
import { Star, ShieldCheck, ArrowLeft, ArrowRight, Quote } from 'lucide-react';
...
export default function ClientExperiences() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      text: <>We wrapped our entire office reception desk and conference room doors. <strong className={styles.highlightText}>Excellent workmanship</strong> and completed over the weekend to avoid disrupt. The architectural films are top tier. A <strong className={styles.highlightText}>highly recommended</strong> service.</>,
      avatarInitials: "FA"
    },
    {
      id: 3,
  ...
  const yCard4 = useTransform(scrollYProgress, [0, 1], [-15, 15]);
          ...
          <div className={styles.grid}>
            ...
            <motion.div className={styles.leftColumn} variants={leftColumnVariants}>
              ...
              <p className={styles.supportingText}>
                Every transformation tells a story. Discover how our premium wrapping solutions have helped homeowners, offices, restaurants, and commercial spaces achieve a completely new look without expensive renovations.
              </p>
                  ...
                  <motion.div className={styles.starsRow} variants={starContainerVariants}>
                    {[...Array(5)].map((_, i) => (
                      <motion.div key={i} variants={starVariants}>
                        <Star size={16} fill="var(--gold-soft)" className={styles.star} />
                      </motion.div>
                    ))}
                  </motion.div>
                  ...
                  {testimonials.map((review, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        style={cardStyle}
                        whileHover={{ y: isDesktop ? -8 : 0, scale: 1.02 }}
                      >
                        <Quote size={40} className={styles.quoteIcon} />
                        <div className={styles.cardStars}>
                          {[...Array(review.rating)].map((_, i) => (
                            <Star key={i} size={14} fill="var(--gold-soft)" stroke="none" />
                          ))}
                        </div>
                        ...
                        <div className={styles.cardFooter}>
                          ...
                          <div className={styles.verifiedBadgeContainer}>
                            ...
                            <div className={styles.tooltip}>Verified Google Review</div>
                          </div>
                        </div>
                      </motion.div>
                    );
        ...
        <div className={styles.container}>
          <div className={styles.ctaWrapper}>
            ...
            <div className={styles.ctaButtons}>
              ...
              <a href="https://wa.me/971589944602" target="_blank" rel="noopener noreferrer" className={styles.ctaSecondary}>
                Contact Our Team
              </a>
            </div>
          </div>
