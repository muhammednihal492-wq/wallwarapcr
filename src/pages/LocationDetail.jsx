...
const locationData = {
  "dubai": {
    ...
    intro: "As Dubai's leading surface wrapping specialists, WallWrap Creations transforms luxury apartments, villas, and commercial spaces. Our expert installers provide a dust-free, premium interior renovation alternative that brings high-end finishes like wood, marble, and concrete textures directly to your surfaces.",
  ...
  "abu-dhabi": {
    ...
    intro: "WallWrap Creations delivers high-end vinyl wrapping solutions to the UAE capital. Our team helps villas and commercial offices in Abu Dhabi refresh their layouts with durable architectural films that look identical to premium veneer, stone, and leather finishes.",
  ...
  "sharjah": {
    ...
    intro: "Based out of Sharjah Media City (SHAMS), WallWrap Creations provides local residents and business owners with premium interior refacing options. We wrap kitchens, doors, bathroom cabinets, and office workspaces with fire-rated, moisture-resistant architectural wraps.",
  ...
  "ajman": {
    ...
    intro: "WallWrap Creations offers Ajman households and businesses a premium, cost-effective alternative to costly renovations. Our architectural films allow you to completely reface kitchen cupboards, bedroom wardrobes, and doors over a weekend.",
  ...
  "al-ain": {
    ...
    intro: "WallWrap Creations extends its luxury interior wrapping services to Al Ain. We specialize in transforming villa interiors, majlis spaces, and commercial layouts using premium, heat-resistant vinyl films that look and feel identical to real wood, stone, and premium paint.",
  ...
  const localBusinessSchema = [
    {
      ...
      "@type": "LocalBusiness",
      "name": `WallWrap Creations - ${currentCity.cityName}`,
